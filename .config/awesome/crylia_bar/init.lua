...
-- e.g. 1 would be the primary screen and 2 the secondary screen.
	...
	s.top_left = require("crylia_bar.left_bar")(s, { s.layoutlist, s.systray, s.taglist })
        s.top_center = require("crylia_bar.center_bar")(s, s.tasklist)
        s.top_right = require("crylia_bar.right_bar")(s, { s.battery, s.network, s.bluetooth, s.audio, s.kblayout, s.date, s.clock, s.powerbutton })
    end
)
