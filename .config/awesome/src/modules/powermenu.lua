...
return function(s)
    ...
    local reboot_button = button("Reboot", icondir .. "reboot.svg", color["Red"], reboot_command)
    local suspend_button = button("Suspend", icondir .. "suspend.svg", color["Yellow"], suspend_command)
    local logout_button = button("Logout", icondir .. "logout.svg", color["Green"], logout_command)
    local lock_button = button("Lock", icondir .. "lock.svg", color["Orange"], lock_command)

    -- Signals to change color on hover
    Hover_signal(shutdown_button.background, color["Blue"])
    Hover_signal(reboot_button.background, color["Red"])
    Hover_signal(suspend_button.background, color["Yellow"])
    Hover_signal(logout_button.background, color["Green"])
    Hover_signal(lock_button.background, color["Orange"])
