...
return function()
                ...
                {
                    {
                        {
                            id = 'icon',
                            image = gears.color.recolor_image(icondir .. "no-internet" .. ".svg", color["White"]),
        ...
        local update_wireless_icon = function(strength)
            awful.spawn.easy_async_with_shell(
                ...
                function(stdout)
                    ...
                    network_widget.container.network_layout.icon_margin.icon_layout.icon:set_image(gears.color.recolor_image(icondir .. icon .. ".svg", color["Blue"]))
                end
            )
        end
    ...
    local update_disconnected = function()
        ...
        network_widget.container.network_layout.spacing = dpi(0)
        network_widget.container.network_layout.icon_margin.icon_layout.icon:set_image(gears.color.recolor_image(icondir .. icon .. ".svg", color["White"]))
    end
